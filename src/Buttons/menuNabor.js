    ...
    async execute(client, interaction) {
        ...
        switch (type) {
            ...
            case 'EventModNab':
                ...
                placeholder = ['Кира, 21 год, +1 МСК', 'Вела 2 года свою игру на локальном сервере', 'Могу проводить монополию, пазлы. Хочу научиться данеткам', 'Часьл сиэу га ивентах', 'Да. Сейчас ассистент на МЕТА']
                break;
            case 'MafiaModNab1':
